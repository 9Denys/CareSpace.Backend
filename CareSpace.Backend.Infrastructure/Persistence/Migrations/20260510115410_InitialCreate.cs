        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailableServices_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AvailableServices_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceSchedules_ServiceCentres_CentreId",
                        column: x => x.CentreId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceSchedules_TimeSlots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_ServiceSchedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableServices_ServiceId",
                table: "AvailableServices",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AvailableServices_UserId",
                table: "AvailableServices",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceSchedules_CentreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceSchedules_SlotId",
                table: "ServiceSchedules",
                column: "SlotId");
